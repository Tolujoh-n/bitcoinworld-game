...
const FallingFruitGameDebug = () => {
  console.log('FallingFruitGameDebug component is rendering');
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-red-500 p-8 rounded-lg">
          <h1 className="text-4xl font-bold text-white text-center">
            🍎 Falling Fruit Game - DEBUG VERSION
          </h1>
...
export default FallingFruitGameDebug;
